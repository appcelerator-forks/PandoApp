...
function Controller() {
    ...
    navToPersonalUpload ? $.addListener($.__views.__alloyId56, "click", navToPersonalUpload) : __defers["$.__views.__alloyId56!click!navToPersonalUpload"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId56;
    ...
    __defers["$.__views.__alloyId56!click!navToPersonalUpload"] && $.addListener($.__views.__alloyId56, "click", navToPersonalUpload);
    _.extend($, exports);
}
