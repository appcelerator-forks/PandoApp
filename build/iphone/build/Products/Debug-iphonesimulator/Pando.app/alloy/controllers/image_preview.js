...
function Controller() {
    ...
    $.__views.win.rightNavButton = $.__views.__alloyId29;
    onCancel ? $.addListener($.__views.__alloyId29, "keypressed", onCancel) : __defers["$.__views.__alloyId29!keypressed!onCancel"] = true;
    ...
    $.__views.__alloyId30.add($.__views.cropimage);
    ...
    image_save ? $.addListener($.__views.__alloyId31, "click", image_save) : __defers["$.__views.__alloyId31!click!image_save"] = true;
    ...
    __defers["$.__views.__alloyId29!keypressed!onCancel"] && $.addListener($.__views.__alloyId29, "keypressed", onCancel);
    __defers["$.__views.__alloyId31!click!image_save"] && $.addListener($.__views.__alloyId31, "click", image_save);
    _.extend($, exports);
}
