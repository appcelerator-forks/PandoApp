    ...
    extendCollection: function(Collection) {
        _.extend(Collection.prototype, {
            getData: function(category, keyword) {
                ...
                var category_sql = "undefined" != typeof category && "" != category ? " AND item_category = '" + category + "' " : "";
                var keyword_sql = "undefined" != typeof keyword && "" != keyword ? " AND item_name like '%" + keyword + "%' " : "";
                var collection = this;
