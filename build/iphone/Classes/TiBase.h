...
// in simulator we redefine to format for Pando Developer console
...
{\
	NSString * exceptionName = [@"org.pando." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pando";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPandoNativeItemNone = -1, 
	UIPandoNativeItemSpinner = -2,
	UIPandoNativeItemProgressBar = -3,
	
	UIPandoNativeItemSlider = -4,
	UIPandoNativeItemSwitch = -5,
	UIPandoNativeItemMultiButton = -6,
	UIPandoNativeItemSegmented = -7,
	
	UIPandoNativeItemTextView = -8,
	UIPandoNativeItemTextField = -9,
	UIPandoNativeItemSearchBar = -10,
	
	UIPandoNativeItemPicker = -11,
	UIPandoNativeItemDatePicker = -12,
	
	UIPandoNativeItemInfoLight = -13,
	UIPandoNativeItemInfoDark = -14,
	
	UIPandoNativeItemDisclosure = -15,
	
	UIPandoNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Pando instances of
